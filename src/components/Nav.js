        ...
        <div className="navbar-header">
          ...
          <div className="right-elements">
            <ul className="nav-links">
              ...
              <Link style={linkStyle} to='/react-project-shopping_cart/cart'><li className="cart-li"> Cart <FontAwesomeIcon icon={["fas", "shopping-basket"]} className="fa-icon" /> <i className="fab fa-github"></i> 
              {props.itemsQuantity !== 0 &&
              <div className="item-quantity"> {props.itemsQuantity} </div>}</li></Link>
            </ul>
          </div>
        </div>
      </div>
